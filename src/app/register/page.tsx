...
import { Bot, Mail, Lock, User, ArrowRight, Phone } from 'lucide-react';
...
export default function RegisterPage() {
  return (
    <div className="flex min-h-screen">
      {/* Left side - branding */}
      <div className="hidden w-1/2 bg-gradient-to-br from-emerald-600 to-teal-700 lg:flex lg:flex-col lg:justify-between lg:p-12">
        <div>
